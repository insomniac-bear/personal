        ...
        <ul className={styles.presentation}>
          ...
          <li className={styles.item_4}>
            <p className={styles.text}>
              Hello again everyone! So, you already know that my name is Kir, but let me tell you a little bit more about myself. I’m 37 y.o., currently living in Moscow. I’m a web developer and a  snowboarder in my free time. I love to create stuff from scratch and bring peoples most ambitious projects to life.
            </p>
            <p className={styles.text}>
              Why programming? Everything is simple - I love it, as cheesy as it sounds. I do think that it’s a profession of the future, thanks to which I can provide myself and fulfill my dreams - like traveling to all the mountains there is(ambitious, huh? Yes, but not impossible)
            </p>
            <p className={styles.text}>
